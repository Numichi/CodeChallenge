...
import tasks.myfriends.wfrobi.org.mik.oopkata.domain.*;
...
public class TestKata extends AbstractTest {
    ...
    private static final String TEACHER_NAMES[] = new String[] {
        "T1",
        "T2",
        "T3",
        "T4",
    ...
    private static final int TEACHER_YEARS[] = new int[] {
        1985,
        1986,
        1987,
        1988,
    ...
    private static final Institute TEACHER_INSTITUTES[] = new Institute[] {
        Institute.ARCHITECT,
        Institute.ARCHITECT,
    ...
    private static final String STUDENT_NAMES[] = new String[] {
        "S1",
        "S2",
        "S3",
        "S4",
    ...
    private static final int STUDENT_YEARS[] = new int[] {
        1993,
        1994,
        1995,
        1996,
    ...
    private static final Specialization STUDENT_SPECIALIZATIONS[] = new Specialization[] {
    ...
    private static final String ASSISTANT_NAMES[] = new String[] {
        "A1",
        "A2",
        "A3",
        "A4",
    ...
    private static final int ASSISTANT_YEARS[] = new int[] {
        1970,
        1971,
        1972,
        1973,
